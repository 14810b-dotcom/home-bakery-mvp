...
export default function HomePage() {
  ...
  const [clientMode, setClientMode] = useState<ClientMode>("b2b");
  ...
  const t = {
    ...
    tr: {
      ...
      modeB2B: "Toptan Satış (B2B)",
      modeB2C: "Perakende (B2C)",
  ...
  return (
    <div className="min-h-screen font-sans text-neutral-800 bg-neutral-50 relative pb-28 md:pb-24">
      ...
      {/* БЛОК 3: PRODUCTS GRID */}
      <main id="menu-section" className="max-w-6xl mx-auto px-6 py-20 min-h-[50vh]">
              ...
              return (
                ...
                >
                  ...
                  <div className="w-full h-52 rounded-2xl overflow-hidden mb-5 bg-neutral-100 relative">
                    ...
                    {/* B2B Плашка упаковки */}
                    {clientMode === "b2b" && (
                      <div className="absolute bottom-3 left-3 right-3 bg-neutral-900/80 backdrop-blur text-white text-sm font-semibold rounded-lg px-3 py-2 text-center">
                        🛍️ {packDesc}
                      </div>
                    )}
                  </div>
        ...
        <div className="max-w-2xl mx-auto bg-neutral-50 p-8 md:p-12 rounded-[2rem] shadow-2xl border border-neutral-100">
          <div className="mb-10 text-center">
            <span className="inline-block px-4 py-1.5 bg-orange-100 text-orange-700 font-bold rounded-full text-sm mb-4">
              {clientMode === 'b2b' ? texts.modeB2B : texts.modeB2C}
            </span>
      ...
      {/* STICKY BAR (Только для B2C, если есть товары) */}
